            ...
            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                ...
                <c:forEach var="version" items="${versionList}" varStatus="index">
                    <tr class="selected">
                        ...
                        <td>
                            <a onclick="editVersion('${version.id}','${version.versName}','${version.versPrice}');"
                               data-toggle="modal" data-target="#editVersion" class="mr20">编辑</a>
                            <c:if test="${version.versStatus == 1}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addVersionForm" class="form-horizontal" role="form" method="post">
                    <div class="form-group">
                        <label class="col-md-1 control-label" for="form-field-1" style="width: 25%">产品线<span
                    ...
                    <div class="form-group">
                        <label class="col-md-1 control-label" style="width: 25%" for="form-field-1">套餐名称<span
                                class="required-star">*</span>：</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="col-md-1 control-label" style="width: 25%" for="form-field-1">套餐价格<span
                                class="required-star">*</span>：</label>
                        <div class="col-md-9">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"
                        onclick="cancelSava('addVersionForm');">取消
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"
                        onclick="cancelSava('editVersionForm');">取消
                </button>
            </div>
        </div>
    </div>
