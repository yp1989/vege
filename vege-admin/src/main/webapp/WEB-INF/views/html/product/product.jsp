					...
					<tbody>
					    <c:forEach var="product"  items="${productList}" varStatus="index">
							<tr class="selected">
								...
								<td>
									<a onclick="editProduct('${product.id}','${product.productName}');" data-toggle="modal" data-target="#editProduct" class="mr20">编辑</a>
									<c:if test="${product.productStatus == 1}">
	   ...
	   <div class="modal-dialog">
		    <div class="modal-content">
				...
				<div class="modal-body">
				    <form id="addProductForm" class="form-horizontal" role="form" method="post">
				        <div class="form-group">
							<label class="col-md-1 control-label" style="width: 25%" for="form-field-1">产品类型<span class="required-star">*</span>：</label>
							<div class="col-md-9">
				        ...
				        <div class="form-group">
							<label class="col-md-1 control-label" style="width: 25%" for="form-field-1">产品名称<span class="required-star">*</span>：</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							<label class="col-md-1 control-label" style="width: 25%" for="form-field-1">标准版套餐名称<span class="required-star">*</span>：</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							<label class="col-md-1 control-label" style="width: 25%" for="form-field-1">标准金额<span class="required-star">*</span>：</label>
							<div class="col-md-9">
				...
				<div class="modal-footer">
				    ...
				    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" onclick="cancelSava('addProductForm');">取消</button>
				</div>
		    </div>
	   </div>
	</div>
	   ...
	   <div class="modal-dialog">
		    <div class="modal-content">
				...
				<div class="modal-footer">
				    ...
				    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" onclick="cancelSava('editProduct');">取消</button>
				</div>
		    </div>
	   </div>
	</div>
