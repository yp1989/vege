            ...
            <form class="form-horizontal" role="form" action="/gather/index" method="post" id="findForm">
                ...
                <div class="col-md-3 pb10 no-padding-left">
                    <div class="input-group">
                        ...
                        <input type="text" name="custName" placeholder="请输入客户名称" value="${gath.custName}"
                ...
                <div class="col-md-3 pb10 no-padding-left">
                    <div class="input-group">
                        ...
                        <input type="text" name="contNumber" placeholder="请输入合同编号" value="${gath.contNumber}"
                               class="input-sm form-control">
                    </div>
                </div>
                <div class="col-md-3 pb10 no-padding-left">
                    <div class="input-group">
                        ...
                        <select class="input-sm form-control" name="clueStatusOnline" id="clueStatusOnline_id">
                            ...
                            <c:forEach items="${contractType}" var="c" varStatus="index">
                                <option value="${c.code}"
                                        <c:if test="${gath.contType == c.code}">selected</c:if>>${c.desc}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-daterange input-group">
                            <input type="text" class="input-sm form-control" name="createTimestart"
                                   value='<fmt:formatDate value="${gath.gathTimestart}" pattern="yyyy-MM-dd"/>'>
                            <span class="input-group-addon">
												<i class="fa fa-exchange"></i>
											</span>

                            <input type="text" class="input-sm form-control" name="createTimeend"
                                   value='<fmt:formatDate value="${gath.gathTimeend}" pattern="yyyy-MM-dd"/>'>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="input-group">
                        ...
                        <select class="input-sm form-control" name="owner" id="form-field-owner">
                            ...
                            <c:forEach items="${adminList}" var="c" varStatus="index">
                                <option value="${c.id}"
                                        <c:if test="${gath.owner == c.id}">selected</c:if> >${c.adminRealName}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                ...
                <c:forEach items="${page.results}" var="p" varStatus="index">
                    <tr class="selected">
                        ...
                        <td>
                            ...
                            %>
                            <a href="###" class="mr20" id="edit_gather" data-toggle="modal"
                               data-target="#modal_receive_edit" data-id="${p.id}"
                               data-contNumber="${p.contNumber}">编辑</a>
                            <%}%>
                            <c:choose>
...
<!--新增收款-->
<div class="modal fade" id="modal_receive" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" action="/gather/doGather" method="post" id="gatherAddForm">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="pos-rel">
                                <input class="typeahead scrollable" type="text" placeholder="请输入合同编号"
                                       id="Contract_contNumber"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="gathMoney" id="cont_gathMoney" class="col-sm-9"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control date-picker" name="gathDate" type="text"
...
<!--编辑收款-->
<div class="modal fade" id="modal_receive_edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" action="/gather/doGather" method="post"
                      id="gatherAddFormEdit">
                    <div class="form-group">
                        <label class="col-md-3 control-label">关联合同：</label>
                        <div class="col-md-8">
                            <div class="pos-rel">
                                <input class="typeahead scrollable" type="text" placeholder="请输入合同编号"
                                       id="Contract_contNumberEdit"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">本次收款：</label>
                        <div class="col-md-9">
                            <input type="text" name="gathMoney" id="cont_gathMoney_edit" data-old-val=""
                                   class="col-sm-9" id="gathMoney_edit" placeholder="请输入本次收款金额"/>
                            <p class="form-control-static col-sm-2">元</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">收款时间：</label>
                        <div class="col-md-8">
                            <input class="form-control date-picker" name="gathDate" id="gathDate_edit" type="text"
                                   data-date-format="dd-mm-yyyy"/>
                        </div>
                    </div>
