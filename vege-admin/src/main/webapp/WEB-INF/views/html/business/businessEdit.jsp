...
<html lang="en">
	...
	<body class="no-skin">
				<form class="form-horizontal" role="form" method="post" id="addNewCustForm" action="/business/doEdit">
					<input type="hidden"  value="-1" id="clueKnow">
					<input type="hidden"  value="-1" id="clueConsult">
					...
					<div class="row">
						<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" id="form-field-1" name="" class="input-sm form-control" value="${clue.custName}">
									</div>
								</div>
								<div class="form-group">
					...
					<div class="mt20">
						...
						<div class="row">
							<div class="col-md-12">
									...
									<div class="form-group">
										<label class="col-md-1 control-label" for="form-field-1">商机来源<span class="required-star">*</span>：</label>
										<div class="col-md-2">
											<select class="input-sm form-control" name="business.busiSource" id="clueSource">
                                                <option value="">请选择</option>
                                                <c:forEach items="${ClueSource}" var="c" varStatus="index">
                                                    <option value="${c.code}" <c:if test="${business.busiSource == c.code}">selected</c:if>>${c.desc}</option>
                                                </c:forEach>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-md-1 control-label" for="form-field-1">商机类型<span class="required-star">*</span>：</label>
										<div class="col-md-2">
											<select class="input-sm form-control" name="clue.clueType" id="clueType">
												<option value="">请选择</option>
                                                <c:forEach items="${businessType}" var="c" varStatus="index">
                                                    <option value="${c.code}" <c:if test="${business.busiType == c.code}">selected</c:if> >${c.desc}</option>
                                                </c:forEach>
											</select>
										</div>
									</div>
													...
													<div class="form_group pb10">
														...
														<c:forEach items="${p.versionList}" var="v">
															<label class="checkbox-inline no-padding-left">
																<input name="versionIds" type="checkbox" class="ace" value="${v.id}" <c:forEach items="${business.productVersionList}" var="bp"><c:if test="${v.id == bp.id}">checked</c:if></c:forEach> >
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<textarea id="form-field-11" class="input-sm form-control" name="business.remark" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 52px;">${business.remark}</textarea>
										</div>
									</div>
