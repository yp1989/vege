...
<form class="form-horizontal" role="form" method="post" id="addNewCustForm" action="/clue/doAddClue">
    <input type="hidden" name="clue.clueKnow" value="-1">
    <input type="hidden" name="clue.clueConsult" value="-1">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="form-field-111" name="clue.custName" class="input-sm form-control">
                    </div>
                </div>
                <div class="form-group">
