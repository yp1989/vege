    ...
    <div class="row">
        <div class="col-xs-12">
            <form id="addAdminForm" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    <label class="col-md-1 control-label" for="form-field-1" style="width: 10%">部门<span
                ...
                <div class="form-group">
                    <label class="col-md-1 control-label" for="form-field-1" style="width: 10%">角色<span
                            class="required-star">*</span>：</label>
                    <div class="col-md-2">
                ...
                <div class="form-group" style="margin-top: 20px;margin-left: 5%;">
                    <div class="col-md-5">
                        ...
                        <button type="button" onclick="getBack();"
                                class="btn btn-sm btn-primary" style="width: 100px;">返回
                        </button>
                    </div>
                </div>
