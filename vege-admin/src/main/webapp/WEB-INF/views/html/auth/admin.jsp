...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="findForm" class="form-horizontal" method="post"
                  action="${pageContext.request.contextPath}/auth/adminPage">
                ...
                <div class="col-md-3 pb10 no-padding-left">
                    <div class="input-group">
                        ...
                        <input type="text" value="${admin.adminRealName}" name="adminRealName"
                ...
                <div class="col-md-3 pb10 no-padding-left">
                    <div class="input-group">
                        ...
                        <select class="input-sm form-control" name="adminStatus">
                            ...
                            <option
                                    <c:if test="${admin.adminStatus==1}">selected="selected"</c:if> value="1">正常
                            </option>
                            <option
                                    <c:if test="${admin.adminStatus==2}">selected="selected"</c:if> value="2">冻结
                            </option>
                        </select>
                    </div>
                </div>
                <button type="button" class="btn btn-sm btn-primary btn_normal" onclick="queryAdmin();"
                        id="queryAdminBtn" data-fn="submit">查询
                </button>
            </form>
        </div>
                ...
                <c:forEach var="admin" items="${page.results}" varStatus="index">
                    <tr class="selected">
                        ...
                        <td>
                            ...
                            <a data-toggle="modal" data-target="#editAdmin" onclick="editAdmin('${admin.id}');"
                               class="mr20">编辑</a>
                            <c:if test="${admin.adminStatus == 1}">
            ...
            <div class="modal-body">
                <form id="editAdminForm" class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" style="width: 25%;" for="form-field-1">管理员姓名<span
                                class="required-star">*</span>：</label>
                        <div class="col-md-9">
                            <input type="text" name="adminRealName" id="editAdminRealName"
                                   class="input-sm form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-1 control-label" style="width: 25%;" for="form-field-1">角色<span
                                class="required-star">*</span>：</label>
                    ...
                    <div class="form-group">
                        <input type="checkbox" name="isResetPassword" id="editAdminPassword" value="1"
                               style="margin-left: 80%;">重置密码
                    </div>
