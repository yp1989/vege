            ...
            <table class="table table-striped table-bordered table-hover dataTable ">
                ...
                <c:forEach var="admin" items="${page.results}" varStatus="index">
                    <tr>
                            ...
                            <label>
                                <c:choose>
                                    ...
                                    <c:when test="${admin.isDepManager == 1}">
                                        <input name="switch-field-1" checked="checked"
                                               onchange="setIsDepManager(0,'${admin.id}','${admin.adminDep}');"
                                               class="ace ace-switch ace-switch-6" type="checkbox">
                                    </c:when>
                                    <c:otherwise>
                                        <input name="switch-field-1"
                                               onchange="setIsDepManager(1,'${admin.id}','${admin.adminDep}');"
                                               class="ace ace-switch ace-switch-6" type="checkbox">
                                    </c:otherwise>
                                </c:choose>
                        ...
                        <td><a data-toggle="modal" data-target="#move" class="mr20" onclick="moveAdmin('${admin.id}');">移动</a>
                            <!-- <a href="#">删除</a> --></td>
                    </tr>
                </c:forEach>
                </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm" onclick="savaAddDep();" data-dismiss="modal">保存
                </button>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm" onclick="savaUpdateDep();" data-dismiss="modal">
                    保存
                </button>
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">取消</button>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="cancelMove();" class="btn btn-default btn-sm" data-dismiss="modal">取消
                </button>
            </div>
        </div>
    </div>
