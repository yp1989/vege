...
<div class="page-content">
    ...
    <div class="row" style="height: 50px;">
        <div class="col-md-12">
            <a href="${pageContext.request.contextPath}/auth/addRolePage"
               class="btn btn-primary btn-sm btn-filter">添加角色</a>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12">
            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                ...
                <c:forEach var="role" items="${roleList}" varStatus="index">
                    <tr class="selected">
                        ...
                        <td>
                            <a onclick="editRole('${role.id}');" data-toggle="modal" data-target="#editRole"
                               class="mr20">编辑</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editRoleForm" class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group">
                        <label class="col-md-1 control-label" style="width: 20%" for="form-field-1">角色名称<span
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" onclick="cancelSava();">取消
                </button>
            </div>
        </div>
    </div>
