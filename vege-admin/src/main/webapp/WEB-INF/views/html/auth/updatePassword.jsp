                ...
                <div class="widget-body">
                    <div class="widget-main no-padding">
                        <form role="form" method="post" id="updatePasswordForm">
                            ...
                            <fieldset>
                                <label>新密码：</label>
                                <input type="password" disabled="disabled" placeholder="" name="adminPassword"
                                       id="newPassword">
                            ...
                            <fieldset>
                                ...
                                <span id="surePasswordSpan" class="middle"
                                      style="color: red;display: none;">密码不一致</span>
                            </fieldset>
                            <div class="form-actions center">
                                <button type="button" class="btn btn-sm btn-primary" data-fn="submit" onclick="sava();">
                                    保存
                                </button>
                            </div>
                        </form>
