        ...
        <div class="mt20">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-1 control-label">了解方式<span class="required-star">*</span>：</label>
                        <div class="col-md-2">
                    ...
                    <div class="form-group">
                        <label class="col-md-1 control-label">咨询方式<span class="required-star">*</span>：</label>
                        <div class="col-md-2">
                    ...
                    <div class="form-group">
                        <div class="col-md-5">
                            <button type="button" class="btn btn-sm btn-primary" data-fn="submit" id="submitBtn">保存
                            </button>
