        ...
        <div class="mt20">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label class="col-md-1 control-label" for="form-field-1">了解方式<span
                                class="required-star">*</span>：</label>
                        <div class="col-md-2">
                    ...
                    <div class="form-group">
                        <label class="col-md-1 control-label" for="form-field-1">咨询方式<span
                                class="required-star">*</span>：</label>
                        <div class="col-md-2">
                            <select class="input-sm form-control" name="clue.clueConsult" id="clueConsult">
                                ...
                                <c:forEach items="${ClueConsult}" var="c" varStatus="index">
                                    <option value="${c.code}"
                                            <c:if test="${clue.clueConsult == c.code}">selected</c:if> >${c.desc}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
