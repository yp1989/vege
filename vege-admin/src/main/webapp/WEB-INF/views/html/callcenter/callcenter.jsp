            ...
            <form class="form-horizontal" role="form" action="/callcenter/index" method="post" id="findForm">
                ...
                <div class="col-md-3 pb10 no-padding-left">
                    <div class="input-group">
                        ...
                        <input type="text" name="ownerName" placeholder="请输入代理商名称" value="${clue.ownerName}"
                               class="input-sm form-control">
                    </div>
                </div>
                <div class="col-md-3 pb10 no-padding-left">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="请输入公司名称" name="companyName" value=""
                               id="query_agent_companyName" class="input-sm form-control">

                    </div>
                    <button type="button" class="btn btn-sm btn-primary btn_normal" data-fn="submit"
                            id="query_agent_submit">查询
                    </button>
                </div>
            </div>
            ...
            <form class="form-horizontal lead_distribute_agent" role="form" action="/callcenter/addClueToAgent"
                  method="post">
                <div class="modal-footer">
